...
export const activities: Activity[] = [
  {
    slug: "pim-mulder-surfschool",
    title: "Pim Mulder Surfschool",
    description:
      "De bekendste surfschool van Zandvoort. Surflessen voor kids vanaf 6 jaar, stand-up paddle voor het hele gezin. Materiaal inbegrepen. Elke zaterdag en zondag groepslessen.",
    tip: "Boek minstens een week vooruit in het voorjaar.",
    category: "sport",
    subcategory: "Surfen",
  ...
  {
    slug: "kinderboerderij-de-olievaar",
    title: "Kinderboerderij De Olievaar",
    description:
      "Geiten, konijnen, kippen en pony's. Elke dag open, gratis entree. Op woensdag knutselmiddag, op zaterdag ponyrijden (€2). Een vaste waarde in Haarlem-Noord.",
    category: "dieren",
    subcategory: "Kinderboerderij",
    location: "Kampersingel 16, Haarlem",
    area: "Haarlem",
    ageLabel: "Alle leeftijden",
    free: true,
    website: "https://www.kinderboerderijdeolievaar.nl",
  ...
  },
  {
    ...
    price: "€12 per sessie",
    free: false,
    website: "https://www.klimmuurhaarlem.nl",
  ...
  },
  {
    ...
    title: "Nationaal Park Kennemerduinen",
    description:
  ...
  },
  {
    ...
    category: "sport",
    subcategory: "Zwemmen",
    location: "Houtvaartpad 4, Haarlem",
    area: "Haarlem",
    ageLabel: "Alle leeftijden",
    price: "€5,50 / kinderen €4",
    free: false,
    website: "https://www.sportfondsenbad-haarlem.nl",
  ...
  {
    slug: "woelige-nest-bennebroek",
    title: "Kinderboerderij 't Woelige Nest",
    description:
      "Klein en gezellig. Pony's, geiten, varkens en een moestuin waar kinderen mogen helpen. In het weekend vers gebak in het theehuis.",
    category: "dieren",
    subcategory: "Kinderboerderij",
    location: "Bennebroek",
    area: "Bennebroek",
    ageLabel: "Alle leeftijden",
    free: true,
    website: "https://www.hetwoeligenest.nl",
    openingHours: "Wo-zo 10:00 – 16:30",
    image: "https://images.unsplash.com/photo-1535572290543-960a8046f5af?w=800&q=80",
    googlePlaceId: "ChIJuftY5D1dxkcRKZcP0KJ9-3s",
  },
  {
    slug: "haarlemse-judo-club",
    title: "Kenamju Judo Haarlem",
    description:
      "Judolessen voor kinderen vanaf 4 jaar. Twee gratis proeflessen. Leren vallen, balans houden en respect. Wedstrijdteam voor gevorderden.",
    category: "sport",
    subcategory: "Judo",
    location: "Sportpark Schoten, Haarlem",
    area: "Haarlem",
    ageLabel: "4+ jaar",
    ageMin: 4,
    price: "€25/maand",
  ...
  },
  {
    ...
    location: "Korte Begijnestraat 3, Haarlem",
    area: "Haarlem",
    ageLabel: "4+ jaar",
    ageMin: 4,
    price: "€7,50",
  ...
  },
  {
    ...
    category: "sport",
    subcategory: "Surfen",
    location: "Strand Noord, Zandvoort",
    area: "Zandvoort",
    ageLabel: "8 – 14 jaar",
    ageMin: 8,
    ageMax: 14,
    price: "€40 per les",
    free: false,
    website: "https://www.pepsports.nl",
    image: "https://images.unsplash.com/photo-1502680390548-bdbac40ae4e7?w=800&q=80",
